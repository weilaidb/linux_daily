...
void __init mount_root(void)
{
	...
	if(ROOT_DEV == Root_NFS){
		if(mount_nfs_root())
			return;
		printk(KERN_ERR "VFS: Unable to mount root fs va NFSROOT_RETRY_MAX, trying floopy.\n");
		ROOT_DEV = Root_FD0;
	}
...
void __init prepare_namespace(void)
{
	...
	** For exmaple, it is not atypical to wait 5 seconds here 
